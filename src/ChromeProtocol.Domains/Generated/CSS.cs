...
namespace ChromeProtocol.Domains
{
  ...
  public static partial class CSS
  {
    ...
    /// new CSSStyleSheet() (but non-empty if this is a constructed sylesheet imported<br/>
    ...
    public static ChromeProtocol.Domains.CSS.AddRuleRequest AddRule(ChromeProtocol.Domains.CSS.StyleSheetIdType StyleSheetId, string RuleText, ChromeProtocol.Domains.CSS.SourceRangeType Location)    
    {
      return new ChromeProtocol.Domains.CSS.AddRuleRequest(StyleSheetId, RuleText, Location);
    }
    /// <summary>
    /// Inserts a new rule with the given `ruleText` in a stylesheet with given `styleSheetId`, at the<br/>
    /// position specified by `location`.<br/>
    ...
    public static ChromeProtocol.Domains.CSS.SetStyleTextsRequest SetStyleTexts(System.Collections.Generic.IReadOnlyList<ChromeProtocol.Domains.CSS.StyleDeclarationEditType> Edits)    
    {
      return new ChromeProtocol.Domains.CSS.SetStyleTextsRequest(Edits);
    }
    /// <summary>Applies specified style edits one after another in the given order.</summary>
