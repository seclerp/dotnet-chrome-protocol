...
namespace ChromeProtocol.Domains
{
  ...
  public static partial class Page
  {
    ...
    /// <param name="Critical">If criticial, this is a non-recoverable parse error.</param>
    ...
    /// <summary>Enum of possible auto-reponse for permisison / prompt dialogs.</summary>
    [Newtonsoft.Json.JsonConverter(typeof(PrimitiveTypeConverter))]
    ...
    /// <summary>
    /// Returns all browser cookies for the page and all of its subframes. Depending<br/>
    /// on the backend support, will return detailed cookie information in the<br/>
    /// `cookies` field.<br/>
    /// </summary>
    [System.Obsolete("This command marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
    public static ChromeProtocol.Domains.Page.GetCookiesRequest GetCookies()    
    {
      return new ChromeProtocol.Domains.Page.GetCookiesRequest();
    }
    /// <summary>
    /// Returns all browser cookies for the page and all of its subframes. Depending<br/>
    /// on the backend support, will return detailed cookie information in the<br/>
    /// `cookies` field.<br/>
    /// </summary>
    [ChromeProtocol.Core.MethodName("Page.getCookies")]
    [System.Obsolete("This command marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
    public record GetCookiesRequest() : ChromeProtocol.Core.ICommand<GetCookiesRequestResult>
    {
    }
    ...
    public static ChromeProtocol.Domains.Page.PrintToPDFRequest PrintToPDF(bool? Landscape = default, bool? DisplayHeaderFooter = default, bool? PrintBackground = default, double? Scale = default, double? PaperWidth = default, double? PaperHeight = default, double? MarginTop = default, double? MarginBottom = default, double? MarginLeft = default, double? MarginRight = default, string? PageRanges = default, string? HeaderTemplate = default, string? FooterTemplate = default, bool? PreferCSSPageSize = default, string? TransferMode = default, bool? GenerateTaggedPDF = default)    
    {
      return new ChromeProtocol.Domains.Page.PrintToPDFRequest(Landscape, DisplayHeaderFooter, PrintBackground, Scale, PaperWidth, PaperHeight, MarginTop, MarginBottom, MarginLeft, MarginRight, PageRanges, HeaderTemplate, FooterTemplate, PreferCSSPageSize, TransferMode, GenerateTaggedPDF);
    }
    /// <summary>Print page as PDF.</summary>
    /// <param name="Landscape">Paper orientation. Defaults to false.</param>
    /// <param name="DisplayHeaderFooter">Display header and footer. Defaults to false.</param>
    ...
    /// `scripts` are appeneded to the list of scripts for which the cache<br/>
