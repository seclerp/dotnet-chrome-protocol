...
public class ArrayTypeConverter : JsonConverter
{
  ...
  public override void WriteJson(JsonWriter writer, object? instance, JsonSerializer serializer)
  {
    ...
    var properties = type.GetProperty(nameof(IArrayType.Items)).GetValue(instance) as IList<JToken?>;
  ...
  public override object? ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
  {
    ...
    var instance = existingValue ?? Activator.CreateInstance(objectType, jArray);
