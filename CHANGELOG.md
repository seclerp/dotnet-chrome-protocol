...
- Fixes `WebSocketProtocolClient.SendCommandAsync` hanging indefinitely when the underlying WebSocket connection is closed before a command response is received (#44 by @Solution-lab)
